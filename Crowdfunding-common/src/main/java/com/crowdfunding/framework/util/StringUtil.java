...
public class StringUtil {
     ...
     * 手机号判断正则
     */
    static Pattern mobileP = Pattern.compile("^((1[0-9][0-9])|(15[^4,\\D])|(18[0,5-9]))\\d{8}$");
    ...
    public static boolean isMobileNo(String input) {
        Matcher m = mobileP.matcher(input);
        return m.matches();
    }

    /**
     * @description 将字符串数组转换成字符串
     * @return String
     * @author lucy
     * @datetime 2017/12/11 14:41
     */
